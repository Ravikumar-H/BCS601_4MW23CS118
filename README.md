...
## 🛠️ Technology Stack
* **Frontend:** HTML5, CSS3 (Glassmorphism App Theme), JavaScript (DOM manipulation)
...
* `main.py` - The core Python backend server and math logic.
* `templates/index.html` - The frontend application interface and styling.
* `requirements.txt` - Python dependencies required by Google Cloud.
* `app.yaml` - Google App Engine configuration file.
* `README.md` - Project documentation.# BCS601_4MW23CS118
Project based learning on cloud platform: app-engine/database
